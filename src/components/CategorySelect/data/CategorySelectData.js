export const CategoryOptions = [
  { value: 'frontend', label: '프론트엔드', icon: 'i_home_line' },
  { value: 'backend', label: '백엔드', icon: 'i_board_line' },
  { value: 'fullstack', label: '풀스택', icon: 'i_calendar_line' },
  { value: 'algorithm', label: '알고리즘', icon: 'i_chat_line' },
  { value: 'basics', label: '기초지식', icon: 'i_comment_line' },
